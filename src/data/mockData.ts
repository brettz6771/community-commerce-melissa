...
export const MOCK_BOARD_MEMBERS: BoardMember[] = [
  {
    ...
    bio: "Dedicated community leader and passionate champion for Melissa business owners, fostering local economic momentum, high-impact connections, and collaborative growth.",
  ...
  },
  {
    ...
    role: "Vice President",
    business: "Community Commerce Melissa",
    bio: "Strategic business advocate focused on empowering entrepreneurs, driving partnership initiatives, and building strong business networks across North Texas.",
  ...
  {
    id: "board-3",
    name: "Jana Scarpati da Silva",
    role: "Treasurer",
    business: "Community Commerce Melissa",
    bio: "Financial strategist dedicated to maintaining organizational integrity, transparent fiscal management, and sustainable economic growth for our community.",
  ...
  },
  {
    ...
    role: "Board Member",
    business: "Community Commerce Melissa",
    bio: "Active business advocate committed to connecting local founders, supporting community events, and elevating Melissa's business directory.",
  ...
  },
  {
    ...
    role: "Board Member",
    business: "Community Commerce Melissa",
    bio: "Technology and marketing leader dedicated to innovating digital platforms, driving local business visibility, and expanding community outreach.",
  ...
  },
  {
    ...
    role: "Board Member",
    business: "Community Commerce Melissa",
    bio: "Enthusiastic community champion focused on member engagement, local partnerships, and organizing impactful events for Melissa businesses.",
  ...
  },
  {
    ...
    role: "Board Member",
    business: "Community Commerce Melissa",
    bio: "Experienced leader bringing strategic insight, community relationships, and business development focus to the Melissa leadership team.",
