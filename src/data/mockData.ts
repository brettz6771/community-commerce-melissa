...
export const MOCK_BOARD_MEMBERS: BoardMember[] = [
  ...
  },
  {
    id: "board-2",
    name: "Sarah Jenkins",
    role: "Vice President & Event Chair",
    business: "Landmark Title Melissa",
    bio: "With over 15 years in title services and commercial networking, Sarah leads event strategy and sponsor partnerships across North Texas.",
    headshot: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=400",
    funFact: "Has completed 4 marathons and brews her own craft kombucha.",
    email: "sarah@communitycommercemelissa.com",
    phone: "(972) 837-1002"
  },
  {
    id: "board-3",
    name: "Marcus Vance",
    role: "Treasurer & Economic Liaison",
    business: "Vance Financial Solutions",
    bio: "Certified financial planner specializing in small business capitalization, local tax strategies, and economic development in Collin County.",
    headshot: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400",
    funFact: "Avid pilot who flies small aircraft out of nearby McKinney National Airport.",
    email: "marcus@communitycommercemelissa.com",
    phone: "(972) 837-1003"
  },
  {
    id: "board-4",
    ...
    business: "Melissa Family Dental",
    bio: "Elena focuses on welcoming new business owners to Melissa, ensuring every member gains maximum visibility and referral value.",
    headshot: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400",
    funFact: "Loves Texas country music and organizing local charity drives.",
    email: "elena@communitycommercemelissa.com",
    phone: "(972) 837-1004"
  }
];
