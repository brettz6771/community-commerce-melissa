...
export default function HeroSection({ onOpenJoinModal, onOpenVideoModal, onOpenNewsletterModal }: HeroSectionProps) {
  return (
    <section className="relative bg-[#0B0E14] text-white pt-12 pb-24 md:pb-32 overflow-hidden border-b border-white/10">
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-t from-[#0B0E14] via-[#0B0E14]/65 to-[#0B0E14]/20" />
      <div className="absolute top-0 right-0 z-[1] w-96 h-96 bg-slate-400/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/3 z-[1] w-96 h-96 bg-red-900/20 rounded-full blur-3xl pointer-events-none" />
