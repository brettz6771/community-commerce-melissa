          ...
          {MOCK_FOUNDING_MEMBERS.map((member, index) => {
            ...
            return member.website ? (
              <a
                ...
                className="bg-[#1F2736] hover:bg-[#2A3447] border border-slate-600/60 hover:border-slate-300 rounded-xl p-5 text-center flex flex-col items-center justify-between transition-all transform hover:-translate-y-1 shadow-xl group block cursor-pointer"
              >
                {cardContent}
              </a>
            ) : (
