      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold font-outfit uppercase tracking-tight text-white">
            OUR FOUNDING <span className="text-amber-400">MEMBERS</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {MOCK_FOUNDING_MEMBERS.map((member, index) => (
            <div
              key={index}
              className="bg-[#151922] hover:bg-[#1C2230] border border-white/10 hover:border-amber-400/50 rounded-xl p-5 text-center flex flex-col items-center justify-between transition-all transform hover:-translate-y-1 shadow-lg group"
            >
              {/* Badge Icon */}
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-red-900 to-[#0B0E14] border border-amber-400/30 flex items-center justify-center text-amber-400 font-outfit font-extrabold text-sm shadow-inner group-hover:scale-110 transition-transform">
                {member.logoText}
              </div>
              ...
              <div className="mt-3 inline-flex items-center gap-1 text-[9px] bg-amber-400/10 text-amber-300 border border-amber-400/30 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">
          ...
          <div
            ...
            className="bg-gradient-to-br from-red-950/60 to-red-900/40 border-2 border-dashed border-red-500/50 hover:border-amber-400 rounded-xl p-5 text-center flex flex-col items-center justify-center cursor-pointer transition-all hover:scale-105 shadow-xl group min-h-[170px]"
          >
            <div className="w-12 h-12 rounded-full bg-amber-400 text-red-950 flex items-center justify-center shadow-lg group-hover:rotate-90 transition-transform">
